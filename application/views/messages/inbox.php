		...
		<?php if(is_array($messages)){ ?>
          <table class="table">
            ...
            <tr<?php if(!$message['viewed']){?> class="info"<?}?>>
		          ...
		          <td><?php if(!$message['viewed']) echo '<span class="messageUnread">'; ?>
					  ...
					  <?php if(!$message['viewed']) echo '</span>'; ?></td>
                  ...
                  <?php echo anchor('message/send/'.$message['hash'], 'Reply', 'class="btn btn-mini"');?>
