            <div class="col-md-9">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-10 col-xs-offset-2">{form method="form_error" field="password0"}</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-10 col-xs-offset-2">{form method="form_error" field="password1"}</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-10 col-xs-offset-2">{form method="form_error" field="message_pin1"}</div>
                    </div>
