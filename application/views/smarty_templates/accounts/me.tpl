            ...
            <div class="col-md-9" id="own-account">
                ...
                <div class="row">
                    <div class="col-md-12 btn-group">
                       <h2>{$user.user_name|escape} <div class='pull-right'>{url type="anchor" url="account/edit" text="Edit" attr='class="btn btn-default"'} {url type="anchor" url="accounts/password" text="Change Password" attr='class="btn btn-default"'}</div></h2>
                    </div>
                </div>
