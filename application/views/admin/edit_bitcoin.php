			  ...
			  <div class="row-fluid">
				...
				<span class="span4">
				  <div class="input-prepend">
					...
					<input type='text' class='span10' name='account[<?php echo $account; ?>]' value='<?php echo $config[$var]; ?>' /> 
				  </div>
				</span>
			  </div>
			  <div class="row-fluid">
				<span class="span3"></span>
				<span class="span7"><input type='checkbox' name='backup_disabled[<?php echo $account; ?>]' value='1' <?php if($config[$var] == '0.00000000') echo 'checked '; ?>/> Disabled</span>
			  </div>
			  <span class="help-inline offset2"><?php echo form_error('delete_transactions_after'); ?></span>
			<?php } } ?>
