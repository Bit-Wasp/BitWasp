	    <div class="span9 mainContent" id="admin-panel">
		  ...
		  <div class="container-fluid">
			...
			<div class="row-fluid">
			  ...
			  <span class="span7"><?php echo ($config['entry_payment_vendor'] > 0) ? $config['entry_payment_vendor'] : 'Not Required'; ?></span>
			</div>

			<div class="row-fluid">
			  <span class="span3">Buyer Registration Fee:</span>
			  <span class="span7"><?php echo ($config['entry_payment_buyer'] > 0) ? $config['entry_payment_buyer'] : 'Not Required'; ?></span>
			</div>
